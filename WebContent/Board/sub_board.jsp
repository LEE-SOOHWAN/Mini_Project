...
<body bgcolor="#f5f5f5">
	...
	<div align="center" style="padding-top: 50px;">
		<table style="border-top: 3px solid #143046; border-bottom: 3px solid #143046;">
			<caption><p><font size="6" style="color: #3e6b89"><b>${param.category } 게시판</b></font></p></caption>
			...
			<tr class="tr2">
				<c:choose>
					<c:when test="${dto.category == param.category }">
			...
			<tr>
				<td colspan="9" class="tr1">
					...
					<a href="write_view.jsp?id=${param.id }&category=${param.category }">글작성</a>
				</td>
			</tr>
		</table>
	</div>
